 ...
 * --reference=BETA        # change the target reference from integration (int) to beta (beta) to production (prod)
...
var q = require('q');
var testConfig = (new (require('automation-base/lib/config/testConfig.js'))(__dirname)).getConfig();
...
exports.config = {
  ...
  //  proxy: {
  //    proxyType: "PAC",
  //    proxyAutoconfigUrl: "https://some.path.name.com/someFileName.pac"
  //  }
  //
  //},
